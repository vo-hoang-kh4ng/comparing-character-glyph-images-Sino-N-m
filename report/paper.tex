...
\centering\footnotesize
\newcolumntype{L}[1]{>{\raggedright\arraybackslash}p{#1}}
\begin{tabular}{@{}L{2.6cm}L{1.5cm}L{3.5cm}@{}}
\hline
\textbf{Việc} & \textbf{Chi phí} & \textbf{Kỳ vọng} \\
\hline
$n$: 59 $\rightarrow$ 300 & công gán nhãn & CI $\pm13 \rightarrow \pm5{,}7$ điểm \\
Âm theo bộ thủ & sửa sampler & gradient không tắt sớm \\
Semi-hard mining & $+71$\,s/epoch & chưa rõ; cần theo dõi \code{cos} \\
