% =====================================================================
%  BẢN CŨ — ĐÃ BỊ THAY THẾ, KHÔNG NỘP.
%
%  Báo cáo nộp là `report/paper.tex` (định dạng bài hội nghị IEEEtran, 9 trang,
%  5 hình sinh từ số liệu thật, biên dịch được bằng `tectonic -X compile`).
%  File này là bản kỹ thuật dài trước đó, GIỮ LẠI LÀM LỊCH SỬ và CHƯA TỪNG ĐƯỢC
%  BIÊN DỊCH THÀNH CÔNG; nội dung của nó có thể đã lệch so với số liệu hiện tại.
% =====================================================================
% =====================================================================
